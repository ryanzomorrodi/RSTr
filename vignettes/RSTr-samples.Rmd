...
Our age groups lay along the second margin. Let's set a variable `margin_age` to represent our age group margin and standardize our `theta` estimates across ages 35-64 using the `age_standardize()` function:
